...
/// <para>
/// Every call runs on the company-scoped <c>/outher</c> surface with the partner
/// token issued for your integration: you act on the patients of <b>your own
/// company</b>, and the patient is named inline on each request — there is no
...
public sealed class BulutklinikClient
{
    ...
    public BulutklinikClient(BulutklinikClientOptions? options = null)
    {
        ...
        var transport = new Transport(http, baseUrl, options.Lang, store);
